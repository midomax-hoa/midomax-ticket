...
- **Tài khoản DB mặc định:** root / Root@123
...
2. Chạy lệnh tạo database: 
   ...
   ```
3. Đảm bảo bạn có tài khoản `root` với mật khẩu là `Root@123`. Nếu mật khẩu khác, hãy vào file `src/main/resources/application.properties` để sửa lại `spring.datasource.password`.
